...
public class DataLoader implements CommandLineRunner {
    ...
    public DataLoader(OwnerService ownerService, VetService vetService, PetTypeSevice petTypeSevice, SpecialtyService specialityService) {
    ...
    private void loadData() {
        ...
        radiology.setDescription("Detistry");
        ...
        owner1.setTelephone("1231231334");
        ...
        owner2.setTelephone("1231231334");
